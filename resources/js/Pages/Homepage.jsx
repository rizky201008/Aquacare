                    ...
                    <nav>
                        <ul className="flex space-x-4 menu menu-horizontal">
                            {menus.map((menu, index) => (
                                <li key={index}><a href={menu.link} className="hover:underline">{menu.name}</a></li>
                            ))}
                        </ul>
                    </nav>
                </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 bg-white hover:bg-sky-400 cursor-default shadow-lg rounded-lg">
                            <h3 className="text-xl font-bold">Laporan Kualitas Air</h3>
                            <p className="mt-2">Laporkan kualitas air di lokasi anda dan dapatkan bantuan dari
                                petugas</p>
                        </div>
                        <div className="p-6 bg-white hover:bg-sky-400 cursor-default shadow-lg rounded-lg">
                            <h3 className="text-xl font-bold">24/7 Support</h3>
                            <p className="mt-2">Admin dan petugas sedia setiap saat memberikan bantuan 24 jam /7
                                hari</p>
                        </div>
                        <div className="p-6 bg-white hover:bg-sky-400 cursor-default shadow-lg rounded-lg">
                            <h3 className="text-xl font-bold">Lihat Artikel Air</h3>
                            <p className="mt-2">Kami menyajikan artikel tentang kebersihan air dan informasi menarik
                                lainnya</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-black">
                        {blogs.map((blog, index) => (
                            <div key={index}>
                                <BlogItem blogItem={blog} buttons={
